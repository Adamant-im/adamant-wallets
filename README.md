...
```jsonc
{
  ...
  "nodeAdditionalInfo": {
      ...
      "normalServiceUpdateInterval": 210000, // Optional. Service node status update interval in ms
      "crucialServiceUpdateInterval": 30000, // Optional. Crucial service node status update interval in ms
